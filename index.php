...
<head>
	...
	<meta name="description" content="Simulador de Consumo Residencial - Copuryght">
	<meta name="keywords" content="simulador, consumo, energia, demei, uniju�">
...
<body onload='resize()' onresize='resize()'>
	<div class='first_div'>
		...
		<div align="center">
			<img src="Images/demei.png" align="middle" class='img01'> <img src="Images/unijui.png" align="middle" class='img02'> <img src="Images/gaic.png" align="middle" class='img03'>
		</div>
	...
	<div class='load' style='position:absolute; z-index: 200; background-color: rgb(255, 255, 255); width:100%; height:100%;'>
		<img class="loading" src='Casinha/Images/Geral/loading.gif'>
	</div>
</body>
